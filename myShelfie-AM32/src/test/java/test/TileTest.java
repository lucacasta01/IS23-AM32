...
public class TileTest {
    ...
    void setColor(){
        Tile testTile1 = new Tile("testTile", Tile.Color.BLUE);
        testTile1.setColor(Tile.Color.GREEN);
        assertEquals(Tile.Color.GREEN, testTile1.getColor());
        Tile testTile2 = new Tile("testTile", Tile.Color.NULLTILE);
    ...
    void getColor(){
        Tile testTile3 = new Tile("testTile", Tile.Color.YELLOW);
        assertEquals(Tile.Color.YELLOW, testTile3.getColor());
        Tile testTile4 = new Tile("testTile", Tile.Color.WHITE);
        assertEquals(Tile.Color.WHITE, testTile4.getColor());
        Tile testTile5 = new Tile("testTile", Tile.Color.LIGHTBLUE);
